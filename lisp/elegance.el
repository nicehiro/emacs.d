...
(defun reading-english-face ()
	(interactive)
	(setq reading-english-face '(:family "Cormorant Garamond" :height 100))
	(buffer-face-mode))
...
(set-fontset-font "fontset-default"  '(#x2600 . #x26ff) "Fira Code 18")
...
(with-eval-after-load 'rime
	(set-face 'rime-default-face                           'face-strong)
	(set-face 'rime-code-face                                  'default))
